<template>
    <button
        ...
        :disabled="loading"
        :class="[
            'flex items-center gap-1 px-3 py-2 rounded-full text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2',
            saved 
                ? 'bg-red-100 text-red-700 hover:bg-red-200 focus:ring-red-500 border border-red-200' 
                : 'bg-gray-100 text-gray-600 hover:bg-gray-200 focus:ring-gray-500 border border-gray-200',
        ...
        <div class="relative">
            ...
            <svg 
                :class="[
                    ...
                    saved ? 'text-red-500 scale-110' : 'text-gray-400'
                ]"
